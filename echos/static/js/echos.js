(function ($) {
  ...
  var pageAcces = function () {
    ...
    switch (lang) {
      case "en":
        text = "To access the festival location, depart from Le Saix village by foot.\nTo reach the village, the nearest train station is Veynes, 10Km away. Either walk or hitchhik to Le Saix.\nIf you come by car, please consider carpooling.\nWhen approaching le Saix there is a parking. Well, park here. If you came from the south (Serres, Chabestan) the parking would be on your right, 400m before the village facing a lovely orchard ; if you came from Veynes, turn right just before entering the village - stick to the D49 road – and then again turn slightly on your right. After 300m the Parking you long for would be on your left, still facing the orchard.\nOnce you're parked from now on you have to go by foot. Yes, that's right, you must walk, no cars are allowed further down the road. A small bus will take care of your belongings and will carry them to Le Faï, at regular intervals. No passengers allowed in this bus, sorry. You just walk, we tell you.\nSo, you just go straight ahead. You pass the “LE SAIX” signboard, and then the “Ville fleurie” signboard and lo ! you've reach Le Saix village, which you will now cross (notice the road narrow from there), passing by a church on your right hand, and you still moving forward and now the road slightly goes down and then you will see a small bridge and the road goes up again and now you should not be worried for the way is marked you will be safe and shall not be lost.\nAnd then after walking still in the same direction, still straight ahead you'll see the road turning gently (sometimes not so gently) as it enters the valley, and as you move down the road you will witness another signboard which reads : “Attention Route Non Revêtue” which means Beware! Bare Road. You will not beware that much and proceed on your way to the festival.\nNow cross the bridge (after the bridge should stand a green mailbox on your right) and after that the road is not a road anymore but shape itself into a sentry as it goes deeper into the canyon – proceed and now you're surrounded by the cliffs and a small stream, its bubbling water should accompany you a bit on your left and now the road is steeper, after that there is two verry narrow turns on the road, and after these the road is steeper still. Maybe you are tired, maybe your legs hurt, probably you're sweating hard, but hey. Anyway after that you will see a turn on the road toward your left hand, well go there. The way is marked and everything will be fine. And now the slope is softening, the way rocky, and maybe you'll be intruduced with stranges animals made of wood but just keep on walking or half-crawling should you be bold enough to try the shortcuts that you may see, another sharp turn, and then 5 minutes more of walking.\nAnd then...\nHere you are. Well done, you should see us, waiting for you.";
