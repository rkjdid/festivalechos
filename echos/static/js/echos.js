  ...
  var pageTickets = function () {
    ...
    switch (lang) {
      case "en":
        ...
        encart = "Because of the limited space available, you can only access the festival through booking. There will be no ticket sale on the festival.<br>For booking, we’ll be throwing three support event (Lyon, Paris, Marseille, follow on Facebook or by mail) with ticket sale, or please come back on this very page at the begining of June !";
        break;
      default:
        ...
        encart = "À cause du nombre de places limité, le festival est uniquement accessible sur réservation. Il n’y aura pas de vente à l’entrée.<br>Pour réserver, RDV dans nos soirées de soutien (Lyon, Paris et Marseille, infos via Facebook ou mail) ou sur cette page à partir de début juin !";
        break;
    }
    $("#encart").append(encart).addClass("on");
    printText(text);
